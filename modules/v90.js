/* WordPilot v9.0.0 — 3000-word lexicon, secure AI auto-detection,
   shared multilingual concept ledger and permanent Coach 4.0 brand lock. */
const WP90_VERSION='9.0.0';
...
function wp90ApplyVersionLock(){
  if(document.documentElement.dataset.wpVersion!==WP90_VERSION)document.documentElement.dataset.wpVersion=WP90_VERSION;if(document.title!=='WordPilot 9.0 · 3000 Kelime · Conversation Coach 4.0')document.title='WordPilot 9.0 · 3000 Kelime · Conversation Coach 4.0';
  wp90SetText($('.version'),'v9.0.0 · Tester Beta');
