/* WordPilot v9.9.0 — UX Reset & Navigation: simplified home, clear Reader/Academy split, concept tools and secure feedback inbox. */
const WP99_META=Object.freeze({
  version:'9.9.0',
  label:'v9.9.0 · UX Reset',
  title:'WordPilot 9.9 · UX Reset & Navigation',
  description:'WordPilot v9.9.0 — sade ana sayfa, net Academy/Reader ayrımı, merkezi içerik sayıları, Kavram Atlası ve güvenli öneri yönetimi.',
