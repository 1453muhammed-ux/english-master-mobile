/* WordPilot v7.0.0 — SM-2 learning engine, personal daily plan and course-tabbed leagues. */
const WP62_VERSION='7.0.0';
...
function wp62IntegrityScore(base){
  ...
  if(elapsed<0.65||root.awards.length>=45){root.rapid=(Number(root.rapid)||0)+1;setTimeout(()=>toast('Çok hızlı cevap algılandı; bu sorudan PP verilmedi.'),20);return {...base,points:0,integrityBlocked:true}}
...
function wp62UpdateRoadmap(){if(!Array.isArray(WP61_ROADMAP))return;WP61_ROADMAP.splice(0,WP61_ROADMAP.length,
  ...
  ['🛡️','Sunucu doğrulamalı PP','Soru bileti, hız sınırı ve tekrar puanı denetimi','yakında'],
