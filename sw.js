const CACHE='wordpilot-v3.6.2';
const CORE=['./','index.html','style.css?v=3.6.2','app.js?v=3.6.2','manifest.json','icon-192.png','icon-512.png','apple-touch-icon.png'];
const OFFLINE=[...CORE,'words.json?v=3.6.2'];
