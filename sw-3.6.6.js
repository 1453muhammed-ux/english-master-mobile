const CACHE='wordpilot-v3.6.6';
const CORE=['./','index.html','style-3.6.6.css?v=3.6.6','app-3.6.6.js?v=3.6.6','manifest.json','icon-192.png','icon-512.png','apple-touch-icon.png'];
const OFFLINE=[...CORE,'words.json?v=3.6.6'];
